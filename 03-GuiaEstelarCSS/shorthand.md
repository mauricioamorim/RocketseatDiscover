...
* não irá considerar propriedades anteriores (sobreescreve o que foi setado anteriormente)
...
**htts://developer.mozilla.org/en-US/docs/Web/CSS/Shorthand_properties**