...
<head>
  ...
  <title>O que é o diretório node_modules?</title>
</head>
<body>
  <header>O que é o diretório node_modules?</header>
  <main>
    <h1>O que é o diretório node_modules?</h1>
    <p>È o diretórion onde ficam instaladas as dependências adicionadas no package.json</p>
    <p>Essa pasta não deve ir dentro do git pois vc deve dar <code>npm update</code> no servidor q sua aplicação for ser subida.</p>
    <p>Não esqueça de adicionar essa pasta no .gitignore</p>
    <p>Lá dentro se a dependência instalada tambem tiver dependências vc encontrara mais um package.json da dependêmcia</p>
    <span>veja abaixo o package.json do cfonts</span>
    <code>
      {
        "name": "cfonts",
